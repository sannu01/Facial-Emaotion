...
while True:
    ...
    for rect in rects:
        ...
        if leftEAR < EYE_AR_THRESH and rightEAR<EYE_AR_THRESH:
            COUNTER += 1
        elif leftEAR<0.23 or rightEAR<0.23:
            wink+=1
        else:
        ...
        if lap+5<ntime:
            ...
            nor=0
            lap=ntime
            width_height_ratio(leftbrow,rightbrow,jaw,mouth,nose)
            
        cv2.putText(frame, "Wink: {}".format(cwink), (200, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (17, 163, 255), 2)
